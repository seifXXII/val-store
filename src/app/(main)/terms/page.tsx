    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose dark:prose-invert max-w-3xl">
        ...
        <p>
          ...
          However, we reserve the right to correct any errors and to change or
        ...
        <p>
          ...
          payment method provided. We reserve the right to refuse or cancel any
        ...
        <p>
          ...
          responsible for delays caused by shipping carriers or circumstances
          beyond our control.
        </p>

        <h2>6. Returns and Refunds</h2>
        <p>
          Please refer to our Returns & Exchanges page for detailed information
        ...
        <p>
          ...
          <a href="mailto:legal@valstore.com">legal@valstore.com</a>.
        </p>
      </div>
    </div>
  );
